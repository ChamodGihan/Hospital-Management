    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="ourDoctors.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>OUR DOCTORS</h6></a>
          </li>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://lvivity.com/wp-content/uploads/2021/06/hospital-CRM.jpg" alt=""/>
                        <h3>Welcome</h3>
